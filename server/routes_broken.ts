    ...
    try {
      ...
      try {
        if (req.file.mimetype === 'application/pdf') {
          ...
          // If PDF extraction failed or returned empty content, create minimal content
          if (!fileContent || fileContent.trim().length < 50) {
            console.log('PDF extraction failed or returned minimal content, creating minimal content');
